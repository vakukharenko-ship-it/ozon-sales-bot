...
SETTINGS_FILE = "settings.json"  # Файл настроек рассылок
...
async def handle_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "⚙️ Администрирование":
        if not is_admin(chat_id):
            ...
            return
        await update.message.reply_text("Управление менеджерами и настройками:", reply_markup=admin_keyboard())
        return
    ...
    if text == "📖 Справка":
        if is_admin(chat_id):
            help_text = (
                ...
                "• ⚙️ Администрирование – управление доступом менеджеров и настройка рассылок.\n\n"
...
async def handle_admin_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif text == "⚙️ Настройка рассылок":
...
def main():
    ...
    if job_queue:
        ...
        write_log("✅ Планировщик запущен (отправка согласно настройкам).")
    else:
